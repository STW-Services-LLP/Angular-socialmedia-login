...
import { AuthService as socialLoginService, AuthServiceConfig, FacebookLoginProvider, GoogleLoginProvider, SocialLoginModule } from 'angularx-social-login';
...
const config = new AuthServiceConfig([
	{
		...
		provider: new FacebookLoginProvider('1020351302137917')
	},
	{
		id: GoogleLoginProvider.PROVIDER_ID,
		provider: new GoogleLoginProvider('367522413765-c8n0vihepsvfq9ma11tsco1ad0r8e06s.apps.googleusercontent.com')
	}
]);
